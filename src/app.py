...
class ChatNamespace(Namespace):
    def on_connect(self):
        ...
        emit("clients_update", {"totalClients": len(chat_clients)}, broadcast=True)
    ...
    def on_send_message(self, data):
        ...
        new_message = ChatMessage(sender_id, content)
        # Lưu tin nhắn mới
    ...
    def on_send_media(self, data):
        ...
        if mediaList:
            ...
            if mediaListLen and mediaListLen > 0:
                ...
                emit("clients_update", {"media_list": saved_files}, broadcast=True)
